...
lbl_color = Label(root, font = ("VeVerdana", 20, "bold"), bg = "white")
...
class Score():
    ...
    def updateGame(self):
        ...
        self.color = ["Green", "Blue", "Orange", "Pink", "Red", "Yellow", "Purple", "Brown", "Grey", "Black"]
...
btn_check = Button(root, text = "CHECK", command = get_textColor, relief = FLAT, bg = "Cyan", fg = "white", padx = 10, pady = 1, font = ("Verdana", 15))
